            ...
            <div className="container reveal-up">
                ...
                <div className="bg-zinc-800/50 p-7 rounded-2xl md:p-12 ring-1 ring-zinc-50/10 hover:ring-zinc-50/20 transition-all">
                    <p className='text-zinc-300 mb-4 md:mb-8 md:text-xl md:max-w-[60ch] '>
                        Hi, I am Wonjae Kim, a computer science student who enjoys building tools that are both useful and meaningful. I focus on creating clean and functional systems that solve real problems. As a full-stack developer, I work across both frontend and backend to bring complete solutions to life. From mobile apps to machine learning models, I like turning ideas into software that works well and looks good. I believe good technology comes from a mix of logic, design, and empathy.
                        <br />
                        <br />

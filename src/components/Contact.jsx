        ...
        <section id="contact" className='section'>
            <div className='container lg:grid lg:grid-cols-2 lg:items-stretch'>
                <div className='mb-12 lg:mb-0 lg:flex lg:flex-col'>
                    ...
                    <p className='text-zinc-400 mt-3 mb-8 lg:max-w-[45ch] lg:max-w-[30ch] reveal-up'>
                        If you have any questions or would like to collaborate, please don't hesitate to contact me.
                    </p>
                    <div className='flex items-center gap-3 mt-3 reveal-up'>
                        {socialLinks.map(({ href, icon, alt }, key) => (
                            <a href={href}
                                ...
                                ring-inset ring-2 dark:ring-zinc-50/10 ring-zinc-900/10 rounded-lg transition-[background-color,color] 
                ...
                <form action="https://getform.io/f/bejrwmoa"
                    method='POST'
                    className='mx:pl-10 2xl:pl-20'>
                    <div className='md:grid md:items-center md:gap-cols-2 md:gap-2 reveal-up'>
                        <div className='mb-4'>
                            ...
                            <input type="text"
                                ...
                                required
                                className='text-field w-full p-2 border border-gray-300 rounded reveal-up'
                            />
                        </div>

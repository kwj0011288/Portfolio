            ...
            >
                {isMobile ? (
                            ...
                            <div className="absolute bottom-3 right-3 flex gap-2">
                                {githubLink && (
                                    <a
                                        ...
                                        className="w-10 h-10 rounded-lg grid place-items-center transition-transform hover:translate-y-[-5px] z-10
                    ...
                    light:bg-white light:text-zinc-800 light:shadow-md light:ring-1 light:ring-inset light:ring-zinc-900/10"
                        ...
                        <div className="absolute right-4 bottom-3 text-xs flex items-center gap-1 opacity-70 hover:opacity-100 transition-opacity dark:text-zinc-400 light:text-zinc-600 md:flex hidden">
